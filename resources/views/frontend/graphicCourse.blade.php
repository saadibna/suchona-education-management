...
@section('title','Suchona:Graphics design course')
@section('content')
    ...
    <section class="notice" style="margin-top:-40px;">
        <div class="container">
            <div class="col-md-10 mx-auto notice-wrapper py-4 pb-3 py-sm-5 p-md-5">
                ...
                <h2 class="notice-title text-center">Graphics Design batch</h2>
                <div class="row py-4">
                    <div class="col-lg-6">
                        <h5>
        ...
        <div class="row border">
            ...
            <div class="col-md-6 col-sm-6 p-3" id="btn_2">
                <div class="commonButton mb-2 text-center col-sm-6" id="second-border-bottom">
                    ...
                    <div>
                        <h4>How to perform this course ?</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row pt-5 pb-4">
            <div class="col-md-4 col-sm-12 p-3 trainerImgWeb">
                ...
                <h6 class="pt-1"><em>Professional Graphics designer</em></h6>
            </div>
