...
@section('title','Suchona:Digital marketing course')
@section('content')  
    <!--Carousel slider-->
    ...
    <section class="notice" style="margin-top:-40px;">
        <div class="container">
            <div class="col-md-10 mx-auto notice-wrapper py-4 pb-3 py-sm-5 p-md-5">
                ...
                <h2 class="notice-title text-center">Digital Marketing batch</h2>
                <div class="row py-4">
                    <div class="col-lg-6">
                        <h5>
    ...
    <div class="container">
        <div class="row pt-5 pb-4">
            <div class="col-md-4 col-sm-12 p-3 trainerImgWeb">
                ...
                <h6 class="pt-1"><em>Digital marketing expert</em></h6>
            </div>
